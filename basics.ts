...
function getTotalPrice(a: number[]) {
  if (a[0] > a[1]) {
    // console.log(` total amount of tax to be paid ${a[0] - a[1]}`);
  }
  // console.log("no tax to be paid");
}
const a1= ['chanduy','hdgfhdg','ijfdiajifif','uyujhbg','uwdgqudyu'];
console.log(a1.splice(0,3));
console.log(a1);
